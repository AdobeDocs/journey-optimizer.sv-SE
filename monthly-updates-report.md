...
title: Uppdateringsrapport för månatlig dokumentation
...
- [Testa och godkänn](help/rp_landing_pages/test-landing-page.md) - 27 okt
...
- [Kom igång med profiler i Journey Optimizer](help/using/audience/get-started-profiles.md) - 22 okt
- [Kom igång med reseaktiviteter](help/using/building-journeys/about-journey-activities.md) - 27 okt
...
- [Testa din resa](help/using/building-journeys/testing-the-journey.md) - 28 oktober
- [Konfigurera den API-utlösta kampanjåtgärden](help/using/campaigns/api-triggered-campaign-action.md) - 29 okt
- [Definiera den API-utlösta kampanjmålgruppen](help/using/campaigns/api-triggered-campaign-audience.md) - 23 okt
...
- [Ändra körningsadresserna](help/using/configuration/primary-email-addresses.md) - 22 okt
- [Arbeta med regeluppsättningar](help/using/conflict-prioritization/channel-capping.md) - 28 okt
- [Arbeta med regeluppsättningar](help/using/conflict-prioritization/rule-sets.md) - 27 okt
- [Skapa en innehållsexperiment](help/using/content-management/content-experiment.md) - 15 okt
- [Skapa ett fragment](help/using/content-management/create-fragments.md) - 7 okt
- [experimentellt acceleratormått](help/using/content-management/experiment-accelerator-metrics.md) - 24 okt
- [experimentell accelerator](help/using/content-management/experiment-accelerator.md) - 24 okt
...
- [Designa innehåll från grunden i Journey Optimizer](help/using/email/content-from-scratch.md) - 25 okt
- [Konfigurera e-postinställningar](help/using/email/email-settings.md) - 22 okt
- [Importera ditt e-postinnehåll](help/using/email/existing-content.md) - 30 okt
...
- [Använd Assets i Journey Optimizer](help/using/integrations/assets.md) - 28 okt
- [Designa en landningssida](help/using/landing-pages/design-lp.md) - 25 okt
- [Definiera sidspecifikt innehåll för landning](help/using/landing-pages/lp-content.md) - 25 okt
- [Skapa och använd formulär för dina landningssidor](help/using/landing-pages/lp-forms.md) - 24 okt
- [Definiera förinställningar för landningssidor](help/using/landing-pages/lp-presets.md) - 25 okt
- [Garantier och begränsningar för beslutshantering](help/using/offers/decision-management-guardrails.md) - 25 okt
- [Lägg till begränsningar i ett erbjudande](help/using/offers/offer-library/add-constraints.md) - 3 nov
- [Lägg till en kanalaktivitet i en flerstegskampanj](help/using/orchestrated/activities/channels.md) - 14 okt
- [Konfigurationssteg](help/using/orchestrated/file-upload-schema.md) - 8 okt
- [Kom igång med samordnade kampanjer](help/using/orchestrated/gs-orchestrated-campaigns.md) - 29 okt
- [Samordnade kampanjer, skyddsräcken och begränsningar](help/using/orchestrated/guardrails.md) - 8 okt
- [Konfigurationssteg](help/using/orchestrated/manual-schema.md) - 23 okt
- [Skapa din måldimension](help/using/orchestrated/target-dimension.md) - 24 okt
- [Hjälp för extern datasökning](help/using/personalization/external-data-lookup.md) - 28 okt
- [Arrayfunktioner, bibliotek](help/using/personalization/functions/arrays-list.md) - 29 okt
- [Funktionsbiblioteket för datum- och tidsfunktioner](help/using/personalization/functions/dates.md) - 29 okt
- [Lägg till personalisering](help/using/personalization/personalization-build-expressions.md) - 28 okt
- [Personalization-syntax](help/using/personalization/personalization-syntax.md) - 28 okt
- [Designa ett push-meddelande](help/using/push/design-push.md) - 14 okt
- [Konfiguration för push-meddelanden](help/using/push/push-configuration.md) - 23 okt
- [Åtkomst och prenumeration till systemvarningar](help/using/reports/alerts.md) - 28 okt
...
- [Lista med steghändelsefält](help/using/reports/sharing-field-list.md) - 17 okt
- [Översikt över delning av resesteg](help/using/reports/sharing-overview.md) - 17 okt
- [Dokumentationsuppdateringar](help/using/rn/documentation-updates.md) - 29 okt
