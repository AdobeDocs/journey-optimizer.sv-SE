...
>[!TAB Senaste uppdateringar]

Upptäck de senaste funktionerna i Journey Optimizer och förbättringarna i versionsinformationen.

[![läs mer](using/assets/do-not-localize/learn-more-button.svg)](using/rn/release-notes.md)


>[!TAB Iterera kontextdata]

Lär dig hur du använder itereringssyntax för att visa dynamiska listor med data från olika källor i dina meddelanden, inklusive händelser, anpassade åtgärdssvar och andra sammanhangsbaserade data.

[![läs mer](using/assets/do-not-localize/learn-more-button.svg)](using/personalization/iterate-contextual-data.md)


>[!TAB Kampanjsamordning]

Journey Optimizer innehåller nu **Kampanjsamordning**, en ny funktion som är avsedd för varumärkesinitierade gruppkampanjer.

[![läs mer](using/assets/do-not-localize/learn-more-button.svg)](using/orchestrated/gs-orchestrated-campaigns.md)

>[!TAB Tysta timmar]

Med tysta timmar kan du definiera tidsbaserade undantag för e-post-, SMS-, push- och whatsApp-kanaler.

[![läs mer](using/assets/do-not-localize/learn-more-button.svg)](using/conflict-prioritization/quiet-hours.md)
...
[Utforska resor](using/building-journeys/journey.md)
:::
...
[Läs mer om kampanjer](using/campaigns/get-started-with-campaigns.md)
:::
...
[Lär dig Konflikthantering](./using/conflict-prioritization/gs-conflict-prioritization.md)
:::
