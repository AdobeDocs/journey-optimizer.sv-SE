...
+ Nyheter? {#whats-new}
   ...
   + [Rapport över månatliga uppdateringar](../monthly-updates-report.md)
...
+ Resor {#orchestrate-journeys}
   ...
   + [Starthandbok för resan](using/building-journeys/journey-get-started.md)
   + [Resetyper och urvalsguide](using/building-journeys/journey-types-selection.md)
   ...
   + Hantera dina resor {#manage-journey}
      ...
      + [Ordna med taggar](using/building-journeys/tags.md)
   ...
   + Användningsfall {#journey-use-cases}
      ...
      + [Inträdes- och utträdeskriterier för resor](using/building-journeys/entry-exit-criteria-guide.md)
      ...
      + [Skicka e-post endast på vardagar](using/building-journeys/weekday-email-uc.md)
...
+ Lojalitetsutmaningar {#loyalty-challenges}
   ...
   + [Få tillgång till och hantera utmaningar och uppgifter](using/loyalty-challenges/access-loyalty-challenges.md)
...
+ Kampanjer {#campaigns}
   ...
   + Samordnade kampanjer {#orchestrated-campaigns}
      ...
      + Fråga databasen {#query-database}
         ...
         + [Arbeta med fördefinierade filter](using/orchestrated/predefined-filters.md)
...
+ Konflikt och prioritering {#conflict-prioritization}
   ...
   + Skiljeförfarande på resan {#journey-arbitration}
      + [Använd formler för att rangordna resor](using/conflict-prioritization/journey-ranking-formulas.md)
      + [Använd AI-modeller för att rangordna resor](using/conflict-prioritization/journey-ai-models.md)
+ Testa och godkänn {#test}
   + [Testa, validera och godkänn](/help/rp_landing_pages/test-landing-page.md)
...
+ Övervaka och felsök {#monitor}
   + [Kom igång med övervakning och felsökning](/help/rp_landing_pages/troubleshoot-journey-landing-page.md)
   + [Spårning i Journey Optimizer](using/start/get-started-tracking.md)
   ...
   + Övervaka aviseringar och felkoder {#monitor-alerts-errors}
      + [Systemvarningar](using/reports/alerts.md)
      + [Referens för felkoder](using/building-journeys/error-codes-reference.md)
   + Felsökning {#troubleshooting}
      + [Vanliga frågor om felsökning](using/start/troubleshooting.md)
   ...
   + E-postkanal {#email}
      ...
      + Designa e-postinnehåll {#design-email}
         ...
         + Designa innehåll {#add-content}
            ...
            + [Hantera textversionen](using/email/text-version-email.md)
...
+ Innehållshantering {#content-management}
   ...
   + Personalisering {#personalization}
      ...
      + [Iterera över kontextuella data](using/personalization/iterate-contextual-data.md)
   ...
   + Återanvändbara innehållsfragment {#fragments}
      ...
      + [Lägga till kontextuella attribut i publicerade fragment](using/content-management/manage-fragments-contextual-attributes.md)
   ...
   + Användningsexempel för flera lösningar {#combine}
      ...
      + [Arbeta med Experience Manager Content Advisor](using/content-management/aem-content-advisor.md)
      + [Infoga nedräkningstimer](using/integrations/countdown.md)
   ...
   + AI Assistant för innehållsgenerering {#ai-assistant}
      ...
      + Varumärken {#brands}
         ...
         + [Skapa och hantera generativa modeller](using/content-management/generative-models.md)
         + [Utvärdera ert innehåll](using/content-management/brands-score.md)
   ...
   + Innehållsoptimering {#message-optimization}
      + [Kom igång med optimering](using/content-management/gs-message-optimization.md)
      + [Använd målinriktning](using/content-management/optimization-targeting.md)
      + [Använd experimenterande](using/content-management/optimization-experimentation.md)
      + [Kombinera målinriktning och experimenterande](using/content-management/optimization-combination.md)
   ...
   + Beslut {#experience-decisioning}
      ...
      + Skapa rankningar {#experience-decisioning-rankings}
         ...
         + AI-modeller {#experience-decisioning-ai-models}
            ...
            + [Övervaka AI-modellernas prestanda](using/experience-decisioning/ranking/ai-model-observability.md)
      ...
      + Leverera erbjudanden med beslutsunderlag {#decision-policies}
         ...
         + [Utnyttja fragment i beslutspolicyer](using/experience-decisioning/fragments-decision-policies.md)
...
+ Kanalkonfiguration {#configuration}
   ...
   + Implementera en IP-värmerappsplan {#implement-ip-warmup-plan}
      ...
      + [Leveransguide för IP-värmare](using/configuration/ip-warmup-deliverability-guide.md)
