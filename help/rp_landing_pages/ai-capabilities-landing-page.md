...
- **[API:er med AI-funktioner](../using/configuration/ajo-apis.md)** - få tillgång till Journey Optimizer AI och maskininlärningsfunktioner via programmering via RESTful API:er.
