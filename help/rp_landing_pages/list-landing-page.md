...
[Läs mer om&quot;distinkt&quot;](../using/building-journeys/functions/list-functions.md#distinct)
:::
...
[Lär dig mer om&quot;distinktMedNull&quot;](../using/building-journeys/functions/list-functions.md#distinctWithNull)
:::
...
[Utforska funktionsinformation för &#39;filter&#39;](../using/building-journeys/functions/list-functions.md#filter)
:::
...
[Förstå getListItem](../using/building-journeys/functions/list-functions.md#getListItem)
:::
...
[Läs mer om &#39;in&#39;](../using/building-journeys/functions/list-functions.md#in)
:::
...
[Fördjupa dig i &#39;intersect&#39;](../using/building-journeys/functions/list-functions.md#intersect)
:::
...
- **[Använda funktionen `limit` i Adobe Journey Optimizer](../using/building-journeys/functions/list-functions.md#limit)** - Lär dig hur du begränsar en lista till det första eller sista N-elementet med funktionen &#39;limit&#39;.
- **[listSize Function Reference](../using/building-journeys/functions/list-functions.md#listSize)** - Upptäck hur du kan räkna antalet element i en lista med funktionen listSize.
- **[serializeList-funktion i Adobe Journey Optimizer](../using/building-journeys/functions/list-functions.md#serializeList)** - Konvertera listor till strängar med anpassningsbar formatering med funktionen serializeList.
- **[Sorteringsfunktion i Adobe Journey Optimizer](../using/building-journeys/functions/list-functions.md#sort)** - Lär dig hur du sorterar listor med värden eller objekt i naturlig ordning med funktionen &quot;sortera&quot;.
