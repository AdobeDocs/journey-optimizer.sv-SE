...
Om du vill definiera faserna i din IP-värmeringsplan måste du välja en kampanj för varje fas, konfigurera undantag för domäner och målgrupper samt hantera profilmål. Varje fas kan innehålla flera körningar som kommer att konfigureras i nästa avsnitt. Följ de här stegen:
...
>[!CAUTION]
>
>Varje körning måste aktiveras minst 12 timmar före den faktiska sändningstiden och före det dagliga batchsegmenteringsjobbet. I annat fall kanske inte målgruppsutvärderingen slutförs.
...
Du kan även komma åt rapporterna från [kampanjmenyn](../campaigns/manage-campaigns.md#access) eftersom din plan kan använda olika kampanjer. [Visa i kalendern →](../campaigns/manage-campaigns.md#calendar)
