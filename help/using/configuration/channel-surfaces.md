...
* Om det hänvisas till av någon direktresa. Försök att inaktivera en konfiguration som fortfarande används av en direktresa resulterar i ett fel. Om du vill inaktivera en kanalkonfiguration måste du se till att alla direktresor som använder den här konfigurationen stängs eller stoppas. [Lär dig avsluta en resa](../building-journeys/end-journey.md)
