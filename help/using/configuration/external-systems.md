...
Mer information om API:t för capping och hur du konfigurerar regler för capping finns på [den här sidan](https://experienceleague.adobe.com/docs/journeys/using/working-with-apis/capping.html).
