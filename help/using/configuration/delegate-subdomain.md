...
1. Om underdomänen inte har DMARC-poster kan du ange dem här. Om underdomänen hade befintliga DMARC-poster och om de hämtades av [!DNL Journey Optimizer]kan du använda samma värden eller ändra dem efter behov. Läs mer
