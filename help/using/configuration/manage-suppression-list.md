...
>title="Lägg till e-postmeddelanden eller domäner i listan över inaktiveringar"
>abstract="Om du vill fylla i undertryckningslistan kan du lägga till e-postadresser eller domäner manuellt, en åt gången eller i gruppläge, via en CSV-filöverföring. Dessa specifika e-postadresser och/eller domäner kommer inte att kunna skickas."
