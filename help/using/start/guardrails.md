...
Följande skyddsutkast gäller för [e-postkanalen](../../rp_landing_pages/email-landing-page.md):
...
* För varje organisation har Journey Optimizer stöd för en toppvolym på 5 000 inkommande resehändelser per sekund.
