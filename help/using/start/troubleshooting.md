...
Läs mer om hur du integrerar Journey Optimizer analysdata i Customer Journey Analytics [på den här sidan](https://experienceleague.adobe.com/sv/docs/analytics-platform/using/integrations/ajo?lang=en#automatically-configure-journey-optimizer-integration){target="_blank"}.
...
Se även [Adobe Experience Platform Query Service - översikt](https://experienceleague.adobe.com/sv/docs/experience-platform/query/home?lang=en){target="_blank"}.
...
### Reseversioner {#ajo-troubleshooting-journey-versions}
...
### Ingång och utgång {#ajo-troubleshooting-journeys-exit}
...
### Händelser {#ajo-troubleshooting-journey-events}
...
### Anpassade åtgärder {#ajo-troubleshooting-journeys-actions}
...
Se även dokumentationen för [Hantera API-autentiseringsuppgifter](https://experienceleague.adobe.com/sv/docs/experience-platform/access-control/abac/permissions-ui/permissions?lang=en#manage-api-credentials-for-role){target="_blank"}.
