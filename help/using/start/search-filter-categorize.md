...
I takt med att era Adobe Journey Optimizer-projekt växer blir det viktigt att hitta och ordna innehåll. På den här sidan visas hur du snabbt hittar resor, kampanjer och resurser med universell sökning, filtrerar listor för att fokusera på specifika objekt och organiserar arbetet med taggar och kategorier. Med dessa verktyg kan ni navigera i stora volymer, bibehålla en konsekvent design mellan olika team och effektivisera era era dagliga arbetsflöden.
