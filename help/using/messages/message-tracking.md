...
Du kan aktivera spårning på e-postmeddelandenivå genom att kontrollera **[!UICONTROL Open Tracking for email]** och/eller **[!UICONTROL Click Tracking for email]** alternativ när [skapa ett meddelande](create-message.md).
...
Antalet meddelanden som har öppnats och antalet länkar som har klickats visas i [Fliken Körningar](message-monitoring.md).
