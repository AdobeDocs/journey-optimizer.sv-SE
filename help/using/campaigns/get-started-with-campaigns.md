...
>title="Kampanjer"
>abstract="Skapa ett segmenteringsflöde, utforma era flerkanalsmeddelanden och planera era kampanjer. Kanaler som stöds: E-post, SMS, push-meddelanden, direktreklam."
...
>title="Kampanjer"
>abstract="Leverera enstaka eller återkommande utgående transaktionsaktiviteter. Kanaler som stöds: E-post, SMS, push-meddelanden."
...
Använd [!DNL Journey Optimizer] kampanjer för att:
...
**När du ska använda:** Komplexa arbetsflöden för marknadsföring i flera steg
...
**När:** enkel, schemalagd batchkommunikation ska användas
...
**När:** Händelsestyrda meddelanden i realtid med externa system ska användas
...
5. **Konfigurera schema** (för åtgärdskampanjer) eller API-information (för API-utlösta). För åtgärdskampanjer kan du även [skicka med hjälp av påfyllnader](send-using-waves.md) för att leverera meddelandet i grupper över tid.
...
[Konfigurera tysta timmar](../conflict-prioritization/quiet-hours.md)
:::
...
[Optimera kampanjer](../content-management/gs-message-optimization.md)
:::
