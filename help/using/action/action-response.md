...
Detaljerade exempel och syntax för att iterera över anpassade åtgärdssvarsdata i meddelanden finns i [Iterera över kontextuella data med Handlebars](../personalization/iterate-contextual-data.md#custom-action-responses).
