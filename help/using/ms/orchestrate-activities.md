...
title: Skapa flerstegskampanjer med Adobe Journey Optimizer
description: Lär dig skapa flerstegskampanjer med Adobe Journey Optimizer
hide: true
hidefromtoc: true
...
# Samordna kampanjaktiviteter i flera steg {#orchestrate}

När du har [skapat en flerstegskampanj](gs-campaign-creation.md), oavsett om det är från flerstegskampanjmenyn eller i en kampanj, kan du börja organisera de olika uppgifter som ska utföras. För att göra detta finns en visuell arbetsyta som gör att du kan skapa ett kampanjdiagram i flera steg. I det här diagrammet kan du lägga till olika aktiviteter och koppla dem i en sekventiell ordning.

## Lägg till aktiviteter {#add}

I det här skedet av konfigurationen visas diagrammet med en startikon som representerar början av din flerstegskampanj. Om du vill lägga till din första aktivitet klickar du på knappen **+** som är ansluten till startikonen.

En lista över aktiviteter som kan läggas till i diagrammet visas. Vilka aktiviteter som är tillgängliga beror på var du befinner dig i kampanjen i flera steg. När du till exempel lägger till din första aktivitet kan du starta din flerstegskampanj genom att rikta in en målgrupp, dela upp kampanjsökvägen i flera steg eller ange en **Vänta** -aktivitet för att fördröja körningen av flerstegskampanjen. Efter en **Bygg målgrupp** kan du å andra sidan förfina ditt mål med målinriktningsaktiviteter, skicka en leverans till din målgrupp med kanalaktiviteter eller ordna flerstegskampanjprocessen med flödeskontrollaktiviteter.
...
* **Inaktivera/aktivera** aktiviteten. När kampanjen i flera steg körs körs inaktiverade aktiviteter och följande aktiviteter på samma sökväg, och kampanjen i flera steg stoppas.
* **Pausa/återuppta** aktiviteten. När flerstegskampanjen körs pausas den vid den pausade aktiviteten. Motsvarande uppgift och alla som följer den i samma sökväg körs inte.
...
Du kan kopiera kampanjaktiviteter i flera steg och klistra in dem i valfritt arbetsflöde. Målkampanjen i flera steg kan finnas på en annan webbläsarflik.
...
Med Journey Optimizer kan du flytta en aktivitet, tillsammans med allt innehåll i dess underordnade noder (inklusive alla övergångar och aktiviteter i den) till slutet av en annan övergång inom samma flerstegskampanj.
...
I fältet **Maximal körningstid** kan du ange en varaktighet som t.ex. &quot;30s&quot; eller &quot;1h&quot;. Om aktiviteten inte är klar efter att den angivna tiden har gått ut utlöses en varning. Detta påverkar inte hur flerstegskampanjen fungerar.
...
**I fältet Tillhörighet** kan du tvinga en kampanj i flera steg eller en kampanjaktivitet i flera steg att köras på en viss dator. Du måste ange en eller flera tillhörigheter för den aktuella flerstegskampanjen eller flerstegsaktiviteten.
...
Här följer ett exempel på en kampanj i flera steg som utformats för att skicka ett e-postmeddelande till alla kunder (andra än VIP-kunder) med ett e-postmeddelande som är intresserade av kaffemaskiner.

![](assets/workflow-example.png){zoomable="yes"}{zoomable="yes"}

För att uppnå detta har följande aktiviteter lagts till:

* En **[!UICONTROL Fork]**-aktivitet som delar upp flerstegskampanjen i tre sökvägar (en för varje kundgrupp),
...
När du har slutfört flerstegskampanjen lägger du till aktiviteten **[!UICONTROL End]** i slutet av diagrammet. Med den här aktiviteten kan du markera slutet av ett arbetsflöde visuellt och inte ha någon funktionell inverkan.

När du har utformat ett kampanjdiagram i flera steg kan du köra kampanjen i flera steg och spåra förloppet för dess olika uppgifter. [Lär dig hur du startar en kampanj i flera steg och övervakar dess körning](start-monitor-campaigns.md)
