...
title: Viktiga principer för att skapa samordnade kampanjer
description: Lär dig grunderna för samordnade kampanjer med Adobe Journey Optimizer
hide: true
hidefromtoc: true
...
Med Adobe Journey Optimizer kan ni skapa samordnade kampanjer i en visuell arbetsyta för att utforma flerkanalsprocesser som segmentering, kampanjutförande och filhantering.
...
## Viktiga steg för att skapa en orkestrerad kampanj {#gs-ms-campaign-steps}

De viktigaste stegen för att skapa samordnade kampanjer är följande:
