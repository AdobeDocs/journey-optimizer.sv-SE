...
* Meddelandeexport
  ...
  _AJO Message Export Dataset_: lagrar innehållet i skickade e-postmeddelanden och SMS-meddelanden för export. Posterna sparas i 7 kalenderdagar efter intag. Endast tillgängligt för organisationer som har köpt tillägget för meddelandeexport. [Läs mer](../configuration/message-export.md)
...
>[!MORELIKETHIS]
>
>* [Kom igång med datahantering i Journey Optimizer](gs-data.md)
