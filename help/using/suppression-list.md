...
* **Mjuka studsar** <!--and temporary **ignored** errors--> skickar inte omedelbart en e-postadress till listan, men de ökar felräknaren. Flera [återförsök](configuration/retries.md) utförs sedan och när felräknaren når tröskelvärdet läggs adressen till i listan över utelämnanden.
...
>[!NOTE]
>
>Det går inte att skicka adresser för att avbryta prenumerationen till listan över inaktiveringar eftersom de inte får e-post från [!DNL Journey Optimizer]. Deras val hanteras på Experience Platform-nivå. Läs mer på [avanmäl](../using/consent.md).
