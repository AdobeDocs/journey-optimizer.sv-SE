...
Du kan ändra eller uppdatera en samlingskvalificerare (tidigare tagg) genom att göra en PATCH-begäran till [!DNL Offer Library] API.
...
| `{ID}` | Behållaren där taggarna finns. | `tag1234` |
...
Ett godkänt svar returnerar den uppdaterade informationen om insamlingskvalificeraren och insamlingskvalificeraren `id`.
