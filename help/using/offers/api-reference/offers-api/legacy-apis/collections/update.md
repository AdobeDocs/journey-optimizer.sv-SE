...
Du kan ändra eller uppdatera en samling genom att göra en PATCH-förfrågan till [!DNL Offer Library] API
...
Ett godkänt svar returnerar den uppdaterade informationen om samlingen, inklusive dess unika instans-ID och samling `@id`.
