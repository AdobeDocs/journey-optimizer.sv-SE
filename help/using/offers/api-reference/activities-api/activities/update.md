...
Du kan ändra eller uppdatera ett beslut genom att göra en PATCH-begäran till API:t [!DNL Offer Library].
...
Ett godkänt svar returnerar den uppdaterade informationen om beslutet, inklusive beslutet `id`.
