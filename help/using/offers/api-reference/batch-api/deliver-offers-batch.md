...
# Leverera erbjudanden med [!DNL Batch Decisioning] API
...
Följ stegen nedan för att förbereda dina beslut:

* Om du vill exportera ett beslutsresultat skapar du en datauppsättning med schemat ODE-beslutshändelser.
...
Alla begäranden om gruppbeslut kräver följande ytterligare rubriker:
...
| Egenskap | Beskrivning | Exempel |
| -------- | ----------- | ------- |
| `xdm:segmentIds` | Segmentets unika identifierare. Den får bara innehålla ett värde. | `609028e4-e66c-4776-b0d9-c782887e2273` |
...
Se [Beslutsledningens dokumentation](../../get-started/starting-offer-decisioning.md) för en översikt över de viktigaste begreppen.
...
Sluttiden för varje satsbeslut är den tid som förflyter från det att arbetsbelastningen skapas till det beslutsresultat som finns i utdatauppsättningen. Segmentstorleken i POSTENS nyttolast är huvudfaktorn som påverkar batchbeslutstiden från början till slut. Nedan visas några observationer för olika segmentstorlekar:

* segmentstorlek &lt;= 10 kB: 6 minuter
* segmentstorlek &lt;= 1M: 10 minuter
* segmentstorlek &lt;= 15M: 75 minuter

## Begränsningar {#limitations}

Följande begränsningar finns med [!DNL Batch Decisioning] API:

* **Ett batchjobb**: För närvarande kan endast ett batchjobb köras per datauppsättning i taget. Andra förfrågningar besvarar HTTP 429 (för många förfrågningar).
...
Genom att följa den här API-guiden har du kontrollerat arbetsbelastningsstatus och levererade erbjudanden med [!DNL Batch Decisioning] API. Mer information finns i [Översikt över beslutsfattandet](../../get-started/starting-offer-decisioning.md).
