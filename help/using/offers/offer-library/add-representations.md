...
>
>När du använder personaliseringsredigeraren i Beslutshantering stöds bara en delmängd av funktioner. Se [Funktioner som stöds i personaliseringsredigeraren](personalization-editor-supported-functions.md).
...
Du kan anpassa URL-adresser med personaliseringsredigeraren. Läs mer om [personalisering](../../personalization/personalize.md#use-expression-editor). I Beslutshantering stöds endast vissa funktioner. Se [Funktioner som stöds i redigeraren för anpassning](personalization-editor-supported-functions.md).
...
Använd personaliseringsredigeraren för att hämta profilattribut som lagras i Adobe Experience Platform med fackscheman. [Läs mer](https://experienceleague.adobe.com/docs/experience-platform/profile/union-schemas/union-schemas-overview.html?lang=sv-SE){target="_blank"} Information om funktioner som stöds i Beslutshantering finns i [Funktioner som stöds i anpassningsredigeraren](personalization-editor-supported-functions.md).
...
1. Skriv den text som ska visas i erbjudandet.
   ...
   Ni kan personalisera ert innehåll med personaliseringsredigeraren. Läs mer om [personalisering](../../personalization/personalize.md#use-expression-editor). I Beslutshantering stöds endast vissa funktioner. Se [Funktioner som stöds i redigeraren för anpassning](personalization-editor-supported-functions.md).
