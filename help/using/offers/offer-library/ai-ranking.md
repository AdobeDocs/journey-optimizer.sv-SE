...
Vi har utfört flera statistiska tester för att fatta ett datadrivet beslut om att hitta ett robust värde för omskolningsfrekvens och kontrollfönstret för automatisk optimering. I den inledande implementeringen av rankningstjänsten används ett summeringsfönster på 15 dagar och en omskolningsfrekvens på 2 timmar för att bygga Thompsons samplingsmodell.
