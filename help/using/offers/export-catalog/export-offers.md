...
Här är en lista över alla fält som kan användas i **[!UICONTROL Decision Object Repository - Personalized Offers]**-datauppsättningen.
...
**Description:** Calendar constraints avgör om ett beslutsalternativ är giltigt utifrån ett datumintervall. Förutom detta datumintervall kan alternativet inte föreslås.
**text:** objekt
...
**Fält:** description 
**Title:** Description 
**Description:** Profile constradescription. Den används för att förmedla mänskliga läsbara avsikter om hur eller varför den här profilbegränsningen konstruerades och/eller vilket alternativ som kommer att inkluderas eller exkluderas av den.
**Typ:** sträng

**_experience > decisioning > profileConstraints > eligibility Rule**

**Fält:** eligibilityRule 
**Title:** Kvalifikationsregel - 
...
**Description:** Identifierare of the segments 
**Type:** array
