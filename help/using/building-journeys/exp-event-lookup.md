...
* Om du har tillgång till [[!DNL Adobe Experience Platform] Data Distiller](https://experienceleague.adobe.com/en/docs/experience-platform/query/data-distiller/overview){target="_blank"} konfigurerar du automatiska frågor så att nödvändiga data extraheras från händelsen, ändrar dem så att de passar användningsfallet och skriver tillbaka dem till en [profilaktiverad datauppsättning](https://experienceleague.adobe.com/en/docs/experience-platform/catalog/datasets/user-guide#enable-profile){target="_blank"} för aktivering.
