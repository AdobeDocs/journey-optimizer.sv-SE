...
1. Publicera din transaktionsmall.
   ...
   ![Knapp för händelsekopiering som kopierar nyttolast-ID för API-integrering](assets/accintegration-uc-4.png)
...
1. Klicka på **Nyttolastfältet** och klistra in den JSON som skapades tidigare.
   ...
   ![Listruta för val av kampanjkonto för åtgärdsintegrering](assets/accintegration-uc-7.png)

1. Ändra **Konstant** till **Variabel** för e-postadressen och de två anpassningsfälten.

   ![Åtgärdsnyttolastskonfiguration med fältmappning för Campaign-integrering](assets/accintegration-uc-8.png)

1. Skapa nu en ny resa och börja med det event som skapats tidigare.

   ![Researbetsyta med händelse- och kampanjåtgärd konfigurerad](assets/accintegration-uc-9.png)

1. Lägg till åtgärden och mappa varje fält till rätt fält i Journey Optimizer.

   ![Åtgärdsparametermappning med uttrycksredigeraren för dynamiska värden](assets/accintegration-uc-10.png)

1. Testa din resa.

   ![Fullständigt reseflöde med händelseutlösare och körning av Campaign-åtgärd](assets/accintegration-uc-11.png)
