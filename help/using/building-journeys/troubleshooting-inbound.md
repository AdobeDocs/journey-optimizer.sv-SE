...
description: Lär dig hur du felsöker och löser problem med inkommande åtgärder på resorna  [!DNL Adobe Journey Optimizer]
...
1. Konfigurera en **Assurance**-session. Läs mer i [[!DNL Adobe Experience Platform] Assurance-dokumentationen](https://experienceleague.adobe.com/en/docs/experience-platform/assurance/tutorials/using-assurance){target="_blank"}.
