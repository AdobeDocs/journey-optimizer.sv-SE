...
1. Konfigurera en **Assurance**-session. Läs mer i [[!DNL Adobe Experience Platform] Assurance-dokumentationen](https://experienceleague.adobe.com/sv/docs/experience-platform/assurance/tutorials/using-assurance){target="_blank"}.
