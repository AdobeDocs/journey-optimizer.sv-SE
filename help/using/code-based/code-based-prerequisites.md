...
>[!CAUTION]
>
>När ni riktar in er på pseudonyma profiler (oautentiserade besökare) med era kodbaserade upplevelser bör ni överväga att ställa in en TTL (Time-To-Live) för automatisk borttagning av profiler för att hantera ert engagerande profilantal och tillhörande kostnader. [Läs mer](../start/guardrails.md#profile-management-inbound)
