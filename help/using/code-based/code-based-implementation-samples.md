...
➡️ Läs mer om hur du konfigurerar Web SDK för beslut och kodbaserade upplevelser i [dessa självstudier](code-based-decisioning-implementations.md#tutorials)
