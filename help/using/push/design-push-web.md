...
>[!AVAILABILITY]
>
>För närvarande stöder inte webbaserade push-meddelanden i Journey Optimizer funktionen **tyst meddelande**, men de kommer att vara tillgängliga vid ett senare tillfälle.
