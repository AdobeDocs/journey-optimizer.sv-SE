...
Om du vill aktivera **webb-push-meddelanden** kontrollerar du att egenskapen [pushNotifications](https://experienceleague.adobe.com/sv/docs/experience-platform/web-sdk/commands/configure/pushnotifications) är korrekt konfigurerad i Web SDK. Använd sedan [kommandot sendPushSubscription](https://experienceleague.adobe.com/sv/docs/experience-platform/web-sdk/commands/sendpushsubscription) för att registrera push-prenumerationer hos Adobe Experience Platform.
