...
## Åtkomst till AI-modeller {#access-ai-models}

Gå till **[!UICONTROL Decisioning]** > **[!UICONTROL Strategy setup]** och välj **[!UICONTROL AI models]** för att få tillgång till listan över AI-modeller. Alla AI-modeller som skapas i din instans visas i listan.
...
1. Navigera till menyn **[!UICONTROL Decisioning]** > **[!UICONTROL Strategy setup]** och välj **[!UICONTROL AI models]**.
   ...
   Alla AI-modeller som du har skapat hittills visas där.
...
1. Spara och aktivera AI-modellen. När din modell är aktiv kan du [övervaka dess utbildningsstatus och prestanda](ai-model-observability.md).
