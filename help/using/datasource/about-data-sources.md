...
>[!TIP]
>Har du inte använt datahanteringen i Journey Optimizer förut? Börja med översikten [Kom igång med datahantering](../data/gs-data.md) om du vill veta mer om scheman, datauppsättningar, identiteter och dataflöden innan du konfigurerar datakällor.
