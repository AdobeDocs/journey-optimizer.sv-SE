...
title: Reserapport
description: Lär dig hur du använder webbdata från reserapporten
...
Du kommer åt din webbreserapport genom att klicka på knappen **[!UICONTROL View report]** under din resa. [Läs mer](report-gs-cja.md)
