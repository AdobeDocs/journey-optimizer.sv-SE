...
1. Välj hur er målgrupp ska omdirigeras med **[!UICONTROL Target]** listruta:
...
1. Välj **[!UICONTROL Placements]**.  Välj sedan **[!UICONTROL Offer decision]** du vill lägga till i innehållet och klicka på **[!UICONTROL Add]**.
