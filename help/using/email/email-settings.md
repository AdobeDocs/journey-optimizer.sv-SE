...
>
>Innan du skapar en e-postkanalskonfiguration måste du ha skapat minst en IP-pool. [Läs mer](../configuration/ip-pools.md)
...
>[!NOTE]
>
>* Den här funktionen gäller för närvarande endast för e-postkanalen.
