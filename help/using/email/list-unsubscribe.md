...
>[!NOTE]
>
>Ordningen på UTM-parametrarna som läggs till i URL:en är slumpmässig och kan inte kontrolleras. Om systemet kräver parametrar i en viss ordning måste du analysera dem och ordna om dem på din sida.
