...
1. Dra och släpp önskade fält från den vänstra rutan till arbetsytan i mitten och konfigurera dem efter behov.
   ...
   * **Attribut**: profiler som bor i Atlanta, San Francisco eller Seattle och som är födda efter 1980.
     ...
     >[!NOTE]
     >
     >Attributet `frequencyMap` stöds inte för användning i segmentdefinitioner och kan inte användas som en del av målgruppssegmenteringskriterierna. För frekvensbaserad målinriktning bör du överväga att använda regler för frekvensbegränsning enligt affärsreglerna.
