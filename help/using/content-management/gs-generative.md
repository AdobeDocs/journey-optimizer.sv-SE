...
AI Assistant i Adobe Journey Optimizer, som drivs av Microsoft Azure OpenAI och Adobe Firefly, ger förebyggande förslag på varianter av text och bilder. Den här nya funktionen tillhandahåller en **promptbaserad text- och bildgenerering**. Bildgenerering hanteras med Adobe Firefly.
...
<table style="table-layout:fixed; margin-top: 0px; margin-bottom: 0px;">
  <tbody>
    <tr style="border: 0;background-color: #FFFFFF;">
      <td>
        <ul>
          <li>Kinesiska (Hongkong)</li>
          <li>Kinesiska (förenklad)</li>
          <li>Kinesiska (Taiwan)</li>
          <li>Nederländska</li>
        </ul>
      </td>
      <td>
