...
* För visuella fragment kan du redigera ditt innehåll efter behov på samma sätt som för alla e-postmeddelanden som finns på en resa eller en kampanj. [Läs mer](../email/get-started-email-design.md)
  ...
  >[!CAUTION]
  >
  >Fragment är inte korskompatibla mellan Använd teman och Manuell formatering. När du använder ett fragment i e-postinnehåll måste du se till att du använder ett tema som du har definierat för det här fragmentet. [Läs mer](../email/apply-email-themes.md#leverage-themes-fragment)
...
* Använd anpassningsredigeraren [!DNL Journey Optimizer] för uttrycksfragment med alla dess anpassnings- och redigeringsfunktioner för att skapa fragmentinnehållet. [Läs mer](../personalization/personalization-build-expressions.md)
  ...
  >[!NOTE]
  >
  >Uttrycksfragment av JSON-typ valideras syntaktiskt när de sparas, och eventuella fel visas som varningsmeddelanden.
...
>[!CAUTION]
>
>När det har publicerats kan du inte lägga till nya anpassade attribut i ett live-fragment. Om du vill lägga till personaliseringsattribut måste du duplicera fragmentet. [Läs mer](manage-fragments.md#adding-new-attributes)