...
>[!NOTE]
>
>För närvarande bara **e-post** Innehållsmallar stöds.
...
När du har sparat din innehållsmall är den tillgänglig för användning i en kampanj eller på en resa. Oavsett om du har skapat från grunden eller från ett tidigare e-postmeddelande kan du nu använda den här mallen när du skapar [e-post](../email/get-started-email-design.md) inom [!DNL Journey Optimizer]. [Lär dig mer](../email/use-email-templates.md)
...
1. Klicka **[!UICONTROL Create]** och välja hur du vill utforma mallen bland de olika alternativen:
   ...
   * [Designa din e-post från grunden](../email/content-from-scratch.md) via e-postdesignerns gränssnitt.

   * [Kod eller kopiera-klistra in Raw-HTML](../email/code-content.md) direkt in i e-postdesignern.

   * [Importera befintligt HTML-innehåll](../email/existing-content.md) från en fil eller en ZIP-mapp.

   * Använd befintligt innehåll från en lista med inbyggda eller anpassade mallar. Stegen för hur du använder en innehållsmall i ett e-postmeddelande beskrivs i [det här avsnittet](../email/use-email-templates.md).

   ![](../email/assets/content-template-design.png)

1. The [E-postdesigner](../email/get-started-email-design.md) visas. Redigera innehållet efter behov, på samma sätt som för alla e-postmeddelanden som finns på en resa eller en kampanj, beroende på vilket alternativ du valt.
...
Den här mallen kan nu användas när du skapar e-post i [!DNL Journey Optimizer]. [Lär dig mer](../email/use-email-templates.md)
...
När du utformar en [e-post](../email/get-started-email-design.md) i en kampanj eller en resa kan du spara ditt e-postinnehåll för framtida återanvändning. Följ stegen nedan för att göra detta.
...
Du kan nu använda den här mallen när du skapar [e-post](../email/get-started-email-design.md) inom [!DNL Journey Optimizer]. [Lär dig mer](../email/use-email-templates.md)
