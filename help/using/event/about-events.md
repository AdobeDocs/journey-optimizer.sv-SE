...
Mer information om hur olika typer av resor påverkar flödet finns i [det här avsnittet](../building-journeys/entry-management.md#journey-processing-rate).
...
* **Återuppta händelser**: Den tekniska händelsen utlöses när en profil återupptas från en pausad resa. Läs mer om att [återuppta pausade resor](../building-journeys/journey-pause.md#journey-resume-steps).
