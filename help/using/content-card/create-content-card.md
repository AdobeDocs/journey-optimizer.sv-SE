...
1. Aktivera alternativet **[!UICONTROL Enable additional delivery rules]**. Sedan **[!UICONTROL Edit rules]** för att välja händelser och villkor som ska utlösa meddelandet. Regelbyggare gör att användare kan ange villkor och värden som, när de möts, utlöser en uppsättning åtgärder.
...
1. Om ytterligare utlösare krävs använder du växlingsknappen **[!UICONTROL Enable additional delivery rules]**. Ytterligare leveransregler krävs inte.

   Klicka på **[!UICONTROL Edit triggers]** för att välja händelser och villkor för meddelandeleverans. Med regelbyggaren kan du ange villkor och värden som, när de uppfylls, utlöser åtgärder.
