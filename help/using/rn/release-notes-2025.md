...
<p>Mer information finns i den <a href="../content-management/image-to-html.md">detaljerade dokumentationen</a>.</p>
...
### Förbättringar {#oct-25-10-improvements}
...
* **Relationsscheman**\
  Relationsscheman kan nu användas av för att stödja dina relationsmodelleringsbehov i orkestrerade kampanjer. [Läs mer](../orchestrated/gs-schemas.md) - Tillgänglighetsdatum: 23 september 2025
...
<p>Dessutom kan du tillämpa profilattributbaserade avslutningskriterier (som tidigare kallades "globalt filter") på pausade resor för att exkludera profiler baserat på deras attribut.</p>
...
<p>Mer information finns i <a href="../content-management/gs-message-optimization.md">detaljerad dokumentation</a></p>
</td>
</tr>
</tbody>
</table>
...
* **Kampanjer**
   ...
   * **Hastighetskontroll för utgående kampanjer** - Nu kan du aktivera hastighetskontroll för utgående kampanjer (e-post, SMS, push-meddelanden), så att du kan förhindra överbelastning i efterföljande system, som landningssidor eller kundtjänstplattformar. [Läs mer](../campaigns/campaign-schedule.md#set-rate-control)
...
* **Konfiguration**
   ...
   * **Stöd för anpassade attribut med en klickning för att avbryta prenumeration-URL** - Om du hanterar samtycke utanför Adobe kan du ange en extern anpassad slutpunkt genom att definiera en egen länk för att avbryta prenumeration i e-postkonfigurationen med ett enda klick. När mottagarna klickar på länken för att avbryta prenumerationen lägger Journey Optimizer till vissa standardprofilspecifika parametrar i händelsen för att skicka medgivandeuppdatering.
     ...
     Om du vill anpassa länken för att avbryta prenumerationen med ett klick ytterligare kan du nu definiera anpassade attribut som även läggs till i medgivandehändelsen. Den här funktionen är tillgänglig med begränsad tillgänglighet. [Läs mer](../email/list-unsubscribe.md#custom-attributes)
...
* **Skapa och dela spelböcker (privat beta)** - Nu kan du skapa, hantera och dela egna fallspelningsböcker. Den här funktionen är för närvarande bara tillgänglig för en uppsättning organisationer som en privat betaversion. Kontakta din Adobe-representant för att få åtkomst. [Läs mer](../start/ai-features.md#playbooks)
...
Nu kan ni utnyttja anpassade policyer för medgivande genom marknadsföringsåtgärder i konfigurationer av transaktionsbaserade e-postkanaler. [Läs mer](../action/consent.md#surface-marketing-actions)
...
<p>Mer information finns i den <a href="../content-management/generative-full-content.md">detaljerade dokumentationen</a>.</p>
</td>
</tr>
</tbody>
</table>
