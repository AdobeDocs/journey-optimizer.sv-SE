...
<tr>
<td>
<p>En ny uppsättning <strong>migreringsverktyg-API:er</strong> är tillgängliga för att migrera Offer-hanteringsenheter till Experience Decision. Verktyget möjliggör sömlös migrering mellan sandlådor med beroendeupplösning och återställningsfunktioner.</p>
</td>
</tr>
</tbody>
</table>
...
* **SMS-webbhooks** - Webbhooks stöds nu av alla SMS-leverantörer. Du kan konfigurera varje webkrok baserat på dess avsedda syfte, inkommande webbhooks för att hämta inkommande meddelanden och Feedback-webbhooks för att ta emot leveranskvitton, statusuppdateringar och andra meddelanderelaterade händelser.
...
* **Förhindra självgodkännande för resor och kampanjer** - Ett alternativ lades till när en godkännandeprincip skapades eller ställdes in för att förhindra att de som skapar en resa/kampanj godkänner sina egna objekt.
...
<p>Den här funktionen är tillgänglig i begränsad tillgänglighet för en uppsättning organisationer.</p>
<p>Tillgänglighetsdatum: 3 februari 2026</p>
</td>
</tr>
</tbody>
