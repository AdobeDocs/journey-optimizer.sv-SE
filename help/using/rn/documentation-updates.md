...
* En anteckning har lagts till på sidorna Kom igång med profiler och Guardrails för att ange att e-postmeddelanden är skiftlägeskänsliga när data importeras, vilket innebär att dubblettprofiler kan skapas och användas när dessa profiler används. [Läs mer](../audience/get-started-profiles.md)
