...
* En ny sida finns nu tillgänglig för beslutshantering. Här listas alla operatorer, hjälpredor och funktioner som stöds när uttryck byggs i erbjudandeinnehåll, beslutsregler och rankningsformler. Använd den här listan för att undvika körningsfel. Endast de dokumenterade funktionerna stöds av beslutshanteringen. [Läs mer](../offers/personalization-editor-supported-functions.md)
