...
* Dokumentationen för kodbaserade implementeringsexempel har uppdaterats för att inkludera tokenfältet i propositionAction för korrekt spårning och attribuering i beslutet. [Läs mer](../code-based/code-based-implementation-samples.md)
