...
* Det finns nu en ny sida som förklarar vad en kodbaserad upplevelseyta är, inklusive yt-URI:er, hur ytor fungerar som behållare på alla hierarkinivåer (webbsidor, mobilappar, innehållsplatser) och hur de kopplar programimplementeringen till kanalkonfigurationen. [Läs mer](../code-based/code-based-surface.md)

* Nu finns det en ny sida om hur du publicerar och hanterar kodbaserade upplevelser, som att aktivera kampanjer, övervaka leveranser, göra ändringar och stoppa kampanjer. [Läs mer](../code-based/publish-code-based.md)

* Det finns nu en ny sida om testning av kodbaserade upplevelser, som bland annat handlar om hur du förhandsgranskar innehåll med testprofiler, validerar implementeringen med hjälp av webbläsarutvecklingsverktyg eller mobilfelsökningsverktyg och kontrollerar att innehållet visas korrekt före publicering. [Läs mer](../code-based/test-code-based.md)
