...
* Adobe-integreringar som är tillgängliga med Journey Optimizer finns nu listade i avsnittet Connect your systems and environment. [Läs mer](../integrations/ajo-integrations.md)
