...
* Ett skyddsutkast om målanpassning av pseudonyma profiler med inkommande kanaler har lagts till på villkorssidorna för [webb](../web/web-prerequisites.md#profile-management-guardrail), [In-app](../in-app/inapp-configuration.md#profile-management-guardrail), [kodbaserad upplevelse](../code-based/code-based-prerequisites.md#profile-management-guardrail) och [innehållskort](../content-card/content-card-configuration-prereq.md#profile-management-guardrail) samt på sidan [Skyddsutkast och begränsningar](../start/guardrails.md) . Detta skyddsutkast anger att målprofiler som inte är autentiserade eller ännu inte kända ökar det totala antalet profiler som kan användas och kan påverka din fakturering. Därför rekommenderar Adobe att du ställer in en TTL-inställning (Time-To-Live) för automatisk borttagning av profiler för att hantera ditt antal profiler och därmed sammanhängande kostnader.
